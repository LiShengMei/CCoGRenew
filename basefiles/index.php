...
<link rel="shortcut icon" href="Chinese/favicon.ico">
...
<link href="style/safmStyle.css" rel="stylesheet" type="text/css">
...
<div align="center">
  ...
  <table width="900" border="0" cellspacing="0" cellpadding="0" height="1" style="border-collapse: collapse" bordercolor="#111111">
    ...
    <tr>
      ...
      <?php echo '<img border="0" src="images/'.rand(0,9).'.jpg" width="640" height="360">'; ?>
      <?php
					    ...
					    echo '<p align="center">'.$row[word].'<a href="#" target="main"'.$row[jid].'>'.$row[jie].'</a></p>';
						echo '<EMBED SRC=bgs/'.$row[index].'.mp3 LOOP=false AUTOSTART=true HIDDEN=true WIDTH=0 HEIGHT=0></EMBED>';
    ...
    <tr>
          ...
          <td  bgcolor="#FFFFFF" background="#" align="center">
			...
			<div class="boxes">	</div>
			<div class="boxes"><font size="5" face="標楷體" color="#000080"><a href="zhuri1.php">主日信息</a></font> </div>
			<div class="boxes"><font size="5" face="標楷體" color="#000080"><a href="message1.php">祷告聚会</a></font> </div>
			<div class="boxes"><font size="5" face="標楷體" color="#000080"><a href="xslx.php">线上灵修</a></font> </div>
			<div class="boxes"><font size="5" face="標楷體" color="#000080"><a href="jhhd.php">教会活动</a></font> </div>
			<div class="boxes">	</div>
			</div></td>
    </tr>
    ...
    <tr bgcolor="#FFFFFF">
	  ...
	  <div align="center"><font face="Arial"> Phone: (604)951-8462 &nbsp;&nbsp;&nbsp; Email: <a href="mailto:welcome@christchurchofglory.net">welcome@christchurchofglory.net </a></font>&nbsp;<a href="gx.php">Update</a>.<a href="https://hostingmanager.secureserver.net/SQLDBList.aspx?SQLDBType=MYSQL&ci=23451&accountUID=82a5905a-0519-11e1-a1f6-f04da206c13a">Maintenance </a>.<a href="gxpic.php">Pictures</a></div>
      <div align="center"><font face="Arial"><?  echo '欢迎来基督荣耀教会网站，您是本站第<font color="#FF0000">'.file_get_contents($filepath).'</font>位访客';?></font></div>
      </td>
    </tr>
  </table>
